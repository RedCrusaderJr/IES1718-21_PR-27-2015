	...
	public class IES21Importer
	{
		...
		private ResourceDescription CreateConnectivityNodeResourceDescription(ConnectivityNode cimConnectivityNode)
		{
			...
			if (cimConnectivityNode != null)
			{
				...
				IES21Converter.PopulateConnectivityNodeProperties(cimConnectivityNode, rd, importHelper, report);
			}
			return rd;
		}
		...
		private ResourceDescription CreateTerminalResourceDescription(Terminal cimTerminal)
		{
			...
			if (cimTerminal != null)
			{
				...
				IES21Converter.PopulateTerminalProperties(cimTerminal, rd, importHelper, report);
			}
			return rd;
		}
